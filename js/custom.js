...
DD_roundies.addRule('#wrapper,#header,.container, .qbutton a, blockquote,.comment-reply-link', '10px', true);
DD_roundies.addRule('#sidebarsearch div, .navigation a, .comment-nav a', '8px', true);
...
Cufon.replace('h1,h2,h3,h4,h5',{color:'#002182'});
Cufon.replace('#header h2',{color:'#488C01'});
